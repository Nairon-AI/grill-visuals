...
Visual direction and part of the planned component architecture are inspired by [Foglamp Scan](https://github.com/foglamp-labs/foglamp). Foglamp is Apache-2.0 licensed. No Foglamp source is vendored in this initial scaffold; future copied or modified files must retain required notices and be identified in [THIRD_PARTY_NOTICES.md](./THIRD_PARTY_NOTICES.md).
