...
- Distinct Grill Visuals identity; no Foglamp logo or endorsement implication.
- Extract a bounded component core from Apache-licensed Foglamp Scan only after a source/license audit.
- Mark modified copied files and preserve applicable license headers/notices.
